...
import { addToCartAction } from '../../services/MenuPage/MenuPageActionCreators.ts';
...
class MenuPage extends Component {
  ...
  componentDidMount() {
    ...
    console.log('INTEL ==> MENUPAGE', cart_items, totalPayable, totalCartItems)
  ...
  handleAddClick= ({name,id, price, offerPrice, image, type}) => {
    console.log('intel ==> wait', name, id)
  ...
  renderEachDishItem = (index, dish) =>{
    ...
    console.log('intel ==> renderrrdsih', dish)
    return (
      <EachDishItem
        dish={dish}
  ...
  render() {
    ...
    console.log('intel ==> menu loading', loading, data)
    if(loading) {
      return (
        <FullPageLoader />
      )
    ...
    return (
      <div className="MenuPage">
        ...
        <div className={classnames("cart-preview cartDesign layout",!noItemAdded && 'showcartpreview')}>
