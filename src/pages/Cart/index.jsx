...
import { addToCartAction, resetCartData } from '../../services/MenuPage/MenuPageActionCreators.ts';
...
class Cart extends Component {
    ...
    cart_items_final = cart_items_final.filter((item)=> {
      if(item.id===dish.id) {
        ...
        if(item.count===0) {
          ...
          resultbtns = resultbtns.filter(_id=>_id!==dish.id);
  ...
  placeOrder = () => {
    ...
    //   if(false || (res && res.data && !!res.data.success)) {
    //     clearCartData();
    //     this.props.resetCartData();
    //     this.setState({
    //       loading: false,
            ...
            <div className="cartItems">
              ...
              <div className="EachItem p-t-0 layout row">
                <div className="flex xs2 dishImage">
                  <ImageLoader classNames="img-resp" url={'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_100,h_100,c_fill/ysj9t5tox1kzoyupaapp'} />
                </div>
